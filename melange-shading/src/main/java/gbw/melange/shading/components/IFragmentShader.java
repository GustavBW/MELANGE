 ...
 * @author GustavBW
 */
public class IFragmentShader extends ShaderComponent implements gbw.melange.common.shading.components.IFragmentShader {

    private final ShaderClassification classification;
    private boolean isStatic;


    public IFragmentShader(String localName, String code) {
        this(localName, code, ShaderClassification.COMPLEX);
    }
    public IFragmentShader(String localName, String code, ShaderClassification classification){
        this(localName, code, classification, true);
    }
    public IFragmentShader(String localName, String code, ShaderClassification classification, boolean isStatic){
     ...
     */
    public static IFragmentShader constant(Color color){
        ...
        return new IFragmentShader("CONSTANT_RGBA_FRAGMENT("+r+","+g+","+b+","+a+")",code, ShaderClassification.SIMPLE);
    }

    public static final IFragmentShader DEFAULT = new IFragmentShader("MELANGE_DEFAULT_FRAGMENT",
    """
        #ifdef GL_ES
        precision mediump float;
        #endif
    ...
    public static final IFragmentShader DEBUG_UV = new IFragmentShader("MELANGE_DEBUG_UV_FRAGMENT",
        """
        #ifdef GL_ES
        precision mediump float;
        #endif
    ...
    public static final IFragmentShader TRANSPARENT = IFragmentShader.constant(new Color(0,0,0,0));

    public static final IFragmentShader TEXTURE = new IFragmentShader("MELANGE_TEXTURE_FRAGMENT",
    """
        #ifdef GL_ES
        precision mediump float;
        #endif
